export const config = {
  ...
  baseUrl_restaurant_api: 'http://localhost:3001/api/restaurant',
  //baseUrl_menu_api: 'http://restaurant.lihoco.fr/api/menu',
  baseUrl_menu_api: 'http://localhost:3001/api/menu',
  //baseUrl_product_api: 'http://restaurant.lihoco.fr/api/product',
  baseUrl_product_api: 'http://localhost:3001/api/product',
